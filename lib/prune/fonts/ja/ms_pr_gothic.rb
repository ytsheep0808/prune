    ...
    class MsPrGothic < BaseJa
      ...
      def initialize(document, options = {})
        ...
        if bold?(options) && italic?(options)
          self.base_font = pn("MS-PRGothic,BoldItalic")
          ...
          self.base_font = pn("MS-PRGothic,Bold")
          self.flags = calculate_flags(
            :fixed_pitch => true,
            :symbolic => true,
            :force_bold => true)
          ...
          self.base_font = pn("MS-PRGothic,Italic")
          self.flags = calculate_flags(
            :fixed_pitch => true,
            :symbolic => true,
            :italic => true)

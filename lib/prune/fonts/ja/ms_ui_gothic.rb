    ...
    class MsUiGothic < BaseJa
      ...
      def initialize(document, options = {})
        ...
        if bold?(options) && italic?(options)
          self.base_font = pn("MS-UIGothic,BoldItalic")
          ...
          self.base_font = pn("MS-UIGothic,Bold")
          self.flags = calculate_flags(
            :fixed_pitch => true,
            :symbolic => true,
            :force_bold => true)
          ...
          self.base_font = pn("MS-UIGothic,Italic")
          self.flags = calculate_flags(
            :fixed_pitch => true,
            :symbolic => true,
            :italic => true)
